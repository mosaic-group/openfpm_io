...
grid.PointArrayStatus = ['scalar', 'tensor_0_0', 'tensor_0_1', 'tensor_0_2', 'tensor_1_0', 'tensor_1_1', 'tensor_1_2', 'tensor_2_0', 'tensor_2_1', 'tensor_2_2', 'vector']
grid.TimeArray = 'None'

# create a new 'Glyph'
glyph = Glyph(registrationName='Glyph', Input=grid,
    GlyphType='Arrow')
...
tensor_1_1TF2D.ScalarRangeInitialized = 1
tensor_1_1TF2D.Range = [0.0, 4.0, 0.0, 1.0]
...
glyphDisplay.ScaleTransferFunction.Points = [0.0, 0.0, 0.5, 0.0, 5.948717948717949, 1.0, 0.5, 0.0]

# init the 'Piecewise Function' selected for 'OpacityTransferFunction'
glyphDisplay.OpacityTransferFunction.Points = [0.0, 0.0, 0.5, 0.0, 5.948717948717949, 1.0, 0.5, 0.0]
...
pNG1.Writer.FileName = 'catalyst_grid_dist.png'
